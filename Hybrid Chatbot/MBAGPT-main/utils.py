...
openai.api_key = st.secrets["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"]
api_key_pinecone = st.secrets["82c55276-0cc3-4ea3-8e28-d7b1bdb694a3"]
pinecone_environment = st.secrets["asia-southeast1-gcp-free"]
pinecone_endpoint = st.secrets["gs://my-bucket"]
